...
const TopNavigation = ({ menuClicked }) => {
    return (
        <nav className="fixed db dt-l bg-navy w-100 border-box pa3 ph4-l">
            <a className="menu-icon db dtc-l v-mid mid-gray link w-100 w-25-l tc tl-l mb2 mb0-l" href="#" title="Home">
                <div className='menu-icon flex items-center pa0'>
                    <i onClick={menuClicked} className="ri-menu-line near-white f2 dim pa0 mr4"></i>
                    <h2 className='menu-icon logo near-white ma0 f2-l f2 dim pa0'>Todo App</h2>
                </div>
            </a>
